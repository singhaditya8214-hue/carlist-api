...
export default async function handler(req, res) {
    ...
    try {
        console.log("Starting YallaMotors scraper at:", new Date().toISOString());
        ...
        console.log(`YallaMotors scraper completed: ${count} cars processed`);
        ...
        console.error("YallaMotors cron error:", error);
        return res.status(500).json({
